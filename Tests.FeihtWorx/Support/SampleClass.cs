...
namespace Tests.FeihtWorx
{
	...
	public class SampleClass
	{
			...
			[DataField]
			public string WriteOnlyPropertyOutput {get;set;} // == For unit testing

			[DataField("ReallyNotSimpleColumnNameThatNoOneCanEverRememberIn")]
			public string SimpleColumnIn {get;set;} // == For unit testing

			[DataField("ReallyNotSimpleColumnNameThatNoOneCanEverRememberOut")]
			public string SimpleColumnOut {get;set;} // == For unit testing
			
			[DataField]
			public int RequiredParam {get;set;} // == For unit testing

			[DataField]
			public int? OptionalParam1 {get;set;} // == For unit testing

			[DataField]
			public int? OptionalParam2 {get;set;} // == For unit testing

			[DataField]
			public int RequiredParamOut {get;set;} // == For unit testing

			[DataField]
			public int? OptionalParam1Out {get;set;} // == For unit testing

			[DataField]
			public int? OptionalParam2Out {get;set;} // == For unit testing
